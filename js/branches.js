/**
 * AUIPR Multi-Branch & Mission Management (نظام إدارة الممثليات الإقليمية - الاتحاد العربي)
 * Multi-tenant architecture for Lebanon Representation (ممثلية الجمهورية اللبنانية).
 */
...
function initBranchSystem() {
  ...
  // Apply visual adjustments if on Lebanon Representation
  if (isLebanon) {
  ...
  // Inject Branch/Mission Switcher into Dropdown Menu
